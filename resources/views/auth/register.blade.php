...
@section('form')
    ...
    {!! Form::open(['action' => 'Auth\RegisterController@register', 'class' => 'register-form', 'method' => 'post']) !!}
    ...
    <div class="form-group">
        {!! Form::label('name', 'Nom et Prenom', ['class'=>'control-label visible-ie8 visible-ie9']) !!}
    ...
    <div class="form-group">
        {!! Form::label('country_code', 'Pays', ['class'=>'control-label visible-ie8 visible-ie9']) !!}
